namespace TheTankGame.Core
{
    ...
    {
        private const string PartPrefix = "Add";
        ...
        public string AddPart(IList<string> arguments)
        {
            ...
            var vehicleType = this.vehicles[vehicleModel];
            var methodName = PartPrefix + part.GetType().Name;
            var method = vehicleType.GetType().GetMethods().First(m => m.Name == methodName);

            method.Invoke(vehicleType, new object[] { part });
