...
namespace CosmosX.Core
{
    public class ReactorManager : IManager
    {
        ...
        private const string ReactorTypeSuffix = "Reactor";
        ...
        public string ModuleCommand(IList<string> arguments)
        {
            ...
            switch (moduleType)
            {
                case "CryogenRod":
                    ...
                    break;
                case "HeatProcessor":
                    IAbsorbingModule heatProcesor = new HeatProcessor(this.currentId, additionalParameter);
                    this.reactors[reactorId].AddAbsorbingModule(heatProcesor);
                    this.identifiableObjects.Add(heatProcesor.Id, heatProcesor);
                    this.modules.Add(heatProcesor.Id, heatProcesor);
                    break;
                case "CooldownSystem":
