...
namespace _04_StorageMaster.Structure.Tests.EntitiesTests.StorageTests
{
    public class WarehouseTests
    {
        ...
        [Test]
        public void GetVehicleShouldReturnSemiWithCorrectIndex()
        {
            var semi = warehouse.GetVehicle(0);
            Assert.IsNotNull(semi, "GetVehicl doesn't returt correct vehicle");
        }

        [Test]
        public void GetVehicleShouldThrowExceptionIfIndexIsOutOfRange()
        {
            Assert.That(() => warehouse.GetVehicle(12),
