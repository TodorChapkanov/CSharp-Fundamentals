...
namespace _04_StorageMaster.Structure.Tests.EntitiesTests.StorageTests
{
    ...
    public class AutomatedWarehouseTests
    {
        ...
        public void SetUp()
        {
            warehouse = new AutomatedWarehouse("AutomatedWarehouse");
        }

        [Test]
        public void NameSet()
        {
            Assert.That(warehouse.Name == "AutomatedWarehouse",
        ...
        [Test]
        public void GetVehicleShouldReturnTruckWithCorrectIndex()
        {
            var truck = warehouse.GetVehicle(0);
            Assert.IsNotNull(truck, "GetVehicl doesn't returt correct vehicle");
        }
        ...
        {
            Assert.That(() => warehouse.GetVehicle(1),
                Throws.InvalidOperationException
                .With
                .Message
